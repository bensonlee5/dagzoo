...
| 4 | Expand many-class support beyond 10 classes | High | Low-Medium | Medium | TabPFN Unleashed (`2502.02527`) | `src/cauchy_generator/config.py`, `src/cauchy_generator/converters/categorical.py`, `src/cauchy_generator/filtering/extratrees_filter.py` | Wider `n_classes` ranges and class-aware filter thresholds |
